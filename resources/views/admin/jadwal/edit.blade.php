                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="nip" id="nip" required>
                                            ...
                                            @foreach($dosen as $d)
                                                <option value="{{ $d->nip }}" {{ (old('nip') ?? ($currentDosen ? $currentDosen->nip : '')) == $d->nip ? 'selected' : '' }}>
                                                    {{ $d->nip }} - {{ $d->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="id_ruang" id="id_ruang" required>
                                            ...
                                            @foreach($ruang as $r)
                                                <option value="{{ $r->id_ruang }}" {{ (old('id_ruang') ?? $jadwal->id_ruang) == $r->id_ruang ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="semester_tahun" id="semester_tahun" required>
                                            ...
                                            @foreach($semesters as $semester)
                                                <option value="{{ $semester }}" {{ (old('semester_tahun') ?? $jadwal->semester_tahun) == $semester ? 'selected' : '' }}>{{ $semester }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="time" name="jam_mulai" id="jam_mulai" value="{{ old('jam_mulai') ?? $jadwal->jam_mulai }}" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="jam_selesai" class="form-control-label">Jam Selesai</label>
                                        <input class="form-control" type="time" name="jam_selesai" id="jam_selesai" value="{{ old('jam_selesai') ?? $jadwal->jam_selesai }}" required>
                                    </div>
                                </div>
                            </div>
